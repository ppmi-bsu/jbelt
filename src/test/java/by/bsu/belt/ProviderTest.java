...
public class ProviderTest
    ...
    public void test_bign_wrap() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        ...
        for(int level: levels) {
            ...
            Cipher bign = Cipher.getInstance("Bign", new Bee2SecurityProvider())     ;
    ...
    public void test_belt_hash() throws NoSuchAlgorithmException {
        ...
        byte[] hash = MessageDigest.getInstance("Belt").digest();
    ...
    public void test_sign() throws NoSuchAlgorithmException, InvalidKeyException, DigestException, SignatureException {
        ...
        for(int level: levels) {
            ...
            keyPairGenerator.initialize(level);
